...
CREATE TABLE `cart` (
  ...
  UNIQUE KEY `cart_composite_unique` (`User_id`,`Product_id`),
  KEY `User_id _idx` (`User_id`),
  KEY `fk_Product_id _idx` (`Product_id`),
...
INSERT INTO `cart` VALUES (1001,1001,2);
...
-- Dump completed on 2023-10-26 21:49:38
